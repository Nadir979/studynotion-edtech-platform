...
export const fetchCourseDetails = async (courseId) => {
  ...
  try {
    ...
    // If the error is due to a response, we handle it accordingly
    const errorMessage = error?.response?.data?.message || "An error occurred while fetching course details.";
    toast.dismiss(toastId);
